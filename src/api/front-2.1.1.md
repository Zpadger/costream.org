...
|Type|Description|
|:-|:-|
|Enumeration type ScopeState：|This is a type structure that uses constants to represent different types：<br>1Redecl ：0 may redeclare a typedef name<br>2NoRedecl : 1 may not redeclare a typedef name <br>3SU : 2 a structure or a union field <br>4Stream : 3 a stream SPL5Formal : <br>4 a formal parameter<br>6Commal : 5 a SPL composite stream |
|Global type constant Node |*PrimVoid *PrimChar *PrimSchar *PrimUchar *PrimSshort *PrimUshort *PrimSint *PrimUint *PrimSlong *PrimUlong *PrimSlonglong *PrimUlonglong *primFloat *PrimDouble *PrimLongdouble|
||*StaticString|
||*SintZero *UintZero *SlongZero *UlongZero *FloatZero *DoubleZero|
||*PtrVoid *PtrNull|
||*SintOne *UintOne *SlongOne *UlongOne *FloatOne *DoubleOne|
...
|Type|Description|
|:-|:-|
|Structure type symbolstruct：|This is a type structure that defines the information in the symbol table, including：<br>○1const char *name<br>○2Generic *var<br>○3Scope scope<br>○4Symbol *next<br>○5Symbol *shadow<br>○6Symbol *scope_next |
|Structure type Scope |short level <br>short version|
|Structure type ASTsymbolstruct|Extend the symbol table for the COStream program:<br>○1const char *name<br>○2const char *newName<br>○3Generic *oldId<br>○4Generic *newId<br>○5ASTSymbol *next<br>○6ASTSynbol *shadow|
...
|Type|Description|
|:-|:-|
|Structure type OpEntry|This is a type structure that defines the information in the operator：<br>○1const char *text  // Corresponding operator content<br>○2const char *name // Corresponding operator name<br>○3short unary_prec<br>○4short binary_prec	<br>○5Bool left_assoc<br>○6Bool (*unary_eval)(Node *) |
